...
# def DefaultInventoryId(context):
#     """_summary_
#     Args:
#         context (_type_): context object of SQLalchemy, store data requested from the command

#     Returns:
#         return value used as default value of a new column
#     """
#     return context.get_current_parameters()['product_id'] * 10 + context.get_current_parameters()['condition']
...
class Inventory(db.Model, PersistentBase):
    ...
    #     """
    #     Finds a product record by inventory_id
    #     """
    #     logger.info("Processing look up for inventory_id:{}".format(inventory_id))
